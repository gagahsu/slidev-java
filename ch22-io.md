...
<Link to="ch22adv" style="display: inline-block; margin-top: 2rem; padding: 0.75rem 2rem; background: #5eada0; color: #ffffff; border-radius: 8px; text-decoration: none; font-size: 1.1rem; font-weight: 600;">→ 前往自學內容</Link>
